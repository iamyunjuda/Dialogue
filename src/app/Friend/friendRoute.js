...
//주석 추가
    ...
    //10. 친구 요청 거절하기 --> 쿼리로 전달
    app.patch('/app/userIds/:userId/friends/checks', jwtMiddleware,friend.patchFriendRequestRefuse);
    ...
    app.get('/app/userIds/:userId/friends/requests',jwtMiddleware,friend.getFriendRequestList);
    //15.친구 검색하기
